<template>
  <div class="bg-gray-100 p-4">
    <div class="container mx-auto flex flex-col gap-4">
      <div
        class="bg-white rounded-md p-4 text-center text-2xl font-bold font-zwzt relative text-gray-600"
      >
      ...
      <div class="rounded-md" v-for="group in books" :key="group.year">
        <h2
          class="text-3xl font-bold mb-4 font-zwzt flex items-center justify-center select-none bg-white rounded-md py-4 text-gray-600"
        >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          ...
          >
            ...
            >
              <a
                :href="book.link || 'javascript: void 0;'"
                :title="book.name"
            ...
            <div class="flex flex-1 overflow-hidden">
              ...
              <div class="flex-1 overflow-hidden flex flex-col">
                ...
                <el-text
                  tag="div"
                  line-clamp="4"
                  class="leading-6 indent-[2em] !text-gray-600"
