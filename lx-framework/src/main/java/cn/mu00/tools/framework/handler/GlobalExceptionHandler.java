package cn.mu00.tools.framework.handler;

import cn.dev33.satoken.exception.NotLoginException;
import cn.dev33.satoken.exception.NotRoleException;
import cn.hutool.core.util.ObjectUtil;
import cn.mu00.tools.common.domain.AjaxResult;
...
public class GlobalExceptionHandler {
    ...
    public AjaxResult handleNotLoginException(NotLoginException e, HttpServletRequest request) {
        String requestURI = request.getRequestURI();
        log.error("请求地址'{}',发生未登录异常.", requestURI, e);
        return AjaxResult.error(401, "登录已过期，请重新登录系统");
    }
